import TestimonialInterface from "../../../services/Testimonials/TestimonialInterface";
            ...
            <div className="swiper-slide w-[60%] max-xl:w-[85%]"> 
                    ...
                    <div>
                        ...
                        <div className="flex items-center mb-7 gap-2 text-amber-500 transition-all duration-500  ">
                            ...
                            <span className="text-base font-semibold text-indigo-600">{data.rating}</span>
                        </div>
                    ...
                    <div className="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                        <img className="rounded-full h-10 w-10" src="https://pagedone.io/asset/uploads/1696229969.png"
                            alt="avatar" />
                        <div className="block">
                            <h5 className="max-xl:text-xs text-gray-900 font-medium transition-all duration-500  mb-1">{data.firstName} {data.lastName}</h5>
                            <span className="max-xl:text-xs text-sm leading-4 text-gray-500">{data.role}</span>
                        </div>
                    </div>
