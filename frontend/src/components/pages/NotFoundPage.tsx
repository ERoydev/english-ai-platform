...
/*
    This is my 404 page not found wildcard
*/
...
export default function NotFoundPage() {
    return(
        <div className="h-screen lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-start flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
